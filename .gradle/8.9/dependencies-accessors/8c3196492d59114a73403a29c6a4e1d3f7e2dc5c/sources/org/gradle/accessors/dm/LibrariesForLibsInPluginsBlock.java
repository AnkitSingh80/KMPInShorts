...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final WebLibraryAccessors laccForWebLibraryAccessors = new WebLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>web</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public WebLibraryAccessors getWeb() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForWebLibraryAccessors;
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>driver</b> with <b>com.squareup.sqldelight:android-driver</b> coordinates and
         * with version reference <b>runtime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class CoroutinesLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>extensions</b> with <b>com.squareup.sqldelight:coroutines-extensions</b> coordinates and
         * with version reference <b>runtime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class KmongoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>coroutine</b> with <b>org.litote.kmongo:kmongo-coroutine</b> coordinates and
         * with version reference <b>kmongo.coroutine</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getCoroutine() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kmongo.coroutine");
        }

        /**
         * Dependency provider for <b>serialization</b> with <b>org.litote.kmongo:kmongo-serialization</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getSerialization() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("kmongo.serialization");
        }
    ...
    public static class KotlinxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>uuid</b> with <b>org.jetbrains.kotlinx:kotlinx-uuid</b> coordinates and
         * with version reference <b>kotlinxUuidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class NativeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>driver</b> with <b>com.squareup.sqldelight:native-driver</b> coordinates and
         * with version reference <b>runtime</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class SilkLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>theme</b> with <b>com.varabyte.kobweb:kobweb-silk-theme</b> coordinates and
         * with version reference <b>kobweb</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getTheme() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("silk.theme");
        }
    ...
    public static class SqliteLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>sqliteDriver</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class WebLibraryAccessors extends SubDependencyFactory {

        public WebLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>org.jetbrains.compose.web:web-core</b> coordinates and
         * with version reference <b>webcore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final KmongoVersionAccessors vaccForKmongoVersionAccessors = new KmongoVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>assertk</b> with value <b>0.28.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>delight</b> with value <b>1.5.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getDelight() { return getVersion("delight"); }
        ...
        /**
         * Version alias <b>kobweb</b> with value <b>0.20.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinxUuidVersion</b> with value <b>0.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinxUuidVersion() { return getVersion("kotlinxUuidVersion"); }
        ...
        /**
         * Version alias <b>skie</b> with value <b>0.6.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSkie() { return getVersion("skie"); }

        /**
         * Version alias <b>sqlite</b> with value <b>2.5.0-alpha08</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>sqliteDriver</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSqliteDriver() { return getVersion("sqliteDriver"); }
        ...
        /**
         * Version alias <b>uuid</b> with value <b>0.7.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>webcore</b> with value <b>1.5.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getWebcore() { return getVersion("webcore"); }
        ...
        /**
         * Group of versions at <b>versions.kmongo</b>
         */
        public KmongoVersionAccessors getKmongo() {
            return vaccForKmongoVersionAccessors;
        }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.activityCompose</b> with value <b>1.7.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class ComposeVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>compose.compiler</b> with value <b>1.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>compose.jet</b> with value <b>1.5.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getJet() { return getVersion("compose.jet"); }
    ...
    public static class CoroutinesVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>coroutines.test</b> with value <b>1.10.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KmongoVersionAccessors extends VersionFactory  implements VersionNotationSupplier {

        public KmongoVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>kmongo</b> with value <b>4.9.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> asProvider() { return getVersion("kmongo"); }

        /**
         * Version alias <b>kmongo.coroutine</b> with value <b>5.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCoroutine() { return getVersion("kmongo.coroutine"); }
    ...
    public static class PluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>skie</b> with plugin id <b>co.touchlab.skie</b> and
         * with version reference <b>skie</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getSkie() { return createPlugin("skie"); }

        /**
         * Plugin provider for <b>sqlDelight</b> with plugin id <b>com.squareup.sqldelight</b> and
         * with version reference <b>delight</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
    ...
    public static class ComposePluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>compose.compiler</b> with plugin id <b>org.jetbrains.compose</b> and
         * with version reference <b>compose.jet</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
