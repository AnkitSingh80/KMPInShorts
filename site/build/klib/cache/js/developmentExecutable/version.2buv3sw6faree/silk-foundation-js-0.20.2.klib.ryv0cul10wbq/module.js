(function (factory) {
  ...
  var Companion_getInstance_0 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.g3;
  var _Char___init__impl__6a9atx = kotlin_kotlin.$_$.i2;
  var startsWith = kotlin_kotlin.$_$.cf;
  var endsWith = kotlin_kotlin.$_$.ee;
  var Companion_getInstance_1 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.h3;
  var whiteSpace = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.t2;
  ...
  var Span = kotlin_org_jetbrains_compose_html_html_core.$_$.n5;
  ...
  var asSequence = kotlin_kotlin.$_$.o6;
  var flatMap = kotlin_kotlin.$_$.rd;
  var filter = kotlin_kotlin.$_$.pd;
  var Sequence = kotlin_kotlin.$_$.nd;
  var isInterface = kotlin_kotlin.$_$.dc;
  var map = kotlin_kotlin.$_$.ud;
  var toSet_0 = kotlin_kotlin.$_$.wd;
  var subtract = kotlin_kotlin.$_$.j9;
  ...
  var media = kotlin_org_jetbrains_compose_html_html_core.$_$.r4;
  ...
  var toStyles = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.x2;
  ...
  var distinct = kotlin_kotlin.$_$.g7;
  ...
  var Companion_getInstance_3 = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.a3;
  ...
  var styleModifier = kotlin_com_varabyte_kobweb_kobweb_compose.$_$.v2;
  //endregion
  ...
  initMetadataForClass(base$2, VOID, VOID, CssStyle);
  ...
  function SpanText(text, modifier, variant, ref, $composer, $changed, $default) {
    ...
    if (!(($dirty & 1171) === 1170) || !$composer_0.get_skipping_3owdve_k$()) {
      ...
      var tmp0 = toModifier_0(get_SpanTextStyle(), [variant_0._v], $composer_0, 6).then_mmfvo6_k$(modifier_0._v);
  ...
  function SpanText$lambda($ref, $text) {
    return function ($this$Span, $composer, $changed) {
      var $composer_0 = $composer;
      registerRefScope($this$Span, $ref._v, $composer_0, 14 & $changed);
  ...
  function ComposableSingletons$DeferredKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref_0(composableLambdaInstance(431504263, false, ComposableSingletons$DeferredKt$lambda_1$lambda_ynev9p));
  }
  ...
  protoOf(CssStyle).addStylesInto_avvx4p_k$ = function (selector, styleSheet, layer) {
    ...
    var tmp0_safe_receiver = lightModifiers.get_wei43m_k$(Companion_getInstance_8().get_BaseKey_nx9788_k$());
    var tmp_0 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.get_modifier_t1pq5c_k$();
    var tmp1_safe_receiver = darkModifiers.get_wei43m_k$(Companion_getInstance_8().get_BaseKey_nx9788_k$());
    ...
    while (_iterator__ex2g4s.hasNext_bitz1p_k$()) {
      var element = _iterator__ex2g4s.next_20eer_k$();
      // Inline function 'com.varabyte.kobweb.silk.style.CssStyle.addStylesInto.<anonymous>' call
      if (!element.equals(Companion_getInstance_8().get_BaseKey_nx9788_k$())) {
        destination.add_utx5q5_k$(element);
      }
    }
  ...
  function base_0(_this__u8e3s4, extraModifier, init) {
    return new base$2(extraModifier, init);
  }
  ...
  function base$2($extraModifier, $init) {
  ...
  function Keyframes$usesColorMode$delegate$lambda(this$0) {
    return function () {
      return !Companion_getInstance_9().isColorModeAgnostic_fn4jgj_k$(this$0.init_1);
    };
  }
  ...
  function ComposableSingletons$BreakpointConditionsKt() {
    ...
    var tmp = this;
    tmp.lambda_1_r8sbbp_1 = ComposableLambda$invoke$ref_2(composableLambdaInstance(321895361, false, ComposableSingletons$BreakpointConditionsKt$lambda_1$lambda_jljler));
  }
  ...
  function not(_this__u8e3s4, params) {
    return Companion_getInstance_5().OfFunctionalPseudoClass_j2u724_k$(_this__u8e3s4, 'not', params.slice());
  }
  ...
  protoOf(ImmutableSilkTheme).get_palette_vetkex_k$ = function ($composer, $changed) {
    var $composer_0 = $composer;
    return this.palettes_1.get_4bsmki_k$(Companion_getInstance_10().get_current_2iudd5_k$($composer_0, 6));
  };
  ...
  function rootColorModeState$delegate$lambda() {
    _init_properties_ColorMode_kt__lz79sc();
    return mutableStateOf(Companion_getInstance_4().get_Instance_ljxvgi_k$().get_initialColorMode_i1z52t_k$());
  }
  ...
  _.$_$.l1 = RectF_init_$Create$_2;
  _.$_$.m1 = Companion_getInstance_6;
