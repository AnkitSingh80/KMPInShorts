...
@class SharedBase, SharedMutableSet<E>, SharedMutableDictionary<K, V>, SharedNumber, SharedByte, SharedUByte, SharedShort, SharedUShort, SharedInt, SharedUInt, SharedLong, SharedULong, SharedFloat, SharedDouble, SharedBoolean, SharedKotlinCancellationException, SharedKotlinIllegalStateException, SharedKotlinRuntimeException, SharedKotlinException, SharedKotlinThrowable, SharedKotlinByteArray, SharedKotlinArray<T>, SharedKotlinLazyThreadSafetyMode, SharedKotlinEnum<E>, SharedKotlinEnumCompanion, SharedKotlinByteIterator, SharedKotlinAbstractCoroutineContextElement, SharedKotlinLongRange, SharedKotlinLongRangeCompanion, SharedKotlinLongProgression, SharedKotlinLongProgressionCompanion, SharedKotlinUnit, SharedKotlinNothing, SharedKotlinKTypeProjection, SharedKotlinKTypeProjectionCompanion, SharedKotlinAbstractCoroutineContextKey<B, E>, SharedKotlinLongIterator, SharedKotlinKVariance, SharedSkieColdFlowIterator<E>, SharedSkieKotlinFlow<T>, SharedSkieKotlinMutableSharedFlow<T>, SharedSkieKotlinMutableStateFlow<T>, SharedSkieKotlinOptionalFlow<T>, SharedSkieKotlinOptionalMutableSharedFlow<T>, SharedSkieKotlinOptionalMutableStateFlow<T>, SharedSkieKotlinOptionalSharedFlow<T>, SharedSkieKotlinOptionalStateFlow<T>, SharedSkieKotlinSharedFlow<T>, SharedSkieKotlinStateFlow<T>, SharedSkie_CancellationHandler, SharedSkie_SuspendHandler, SharedSkie_SuspendResult, SharedSkie_SuspendResultCanceled, SharedSkie_SuspendResultError, SharedSkie_SuspendResultSuccess, SharedKotlinx_coroutines_coreCoroutineDispatcher, SharedKotlinx_coroutines_coreCoroutineDispatcherKey, SharedDatabaseHelper, SharedArticle, SharedArticleRaw, SharedArticleRawCompanion, SharedArticlesResponse, SharedArticlesResponseCompanion, SharedArticlesService, SharedArticlesState, SharedArticlesUseCase, SharedArticlesViewModel, SharedBaseViewModel, SharedWebStory, SharedDatabaseDriverFactory, SharedNews, SharedNewsCompanion, SharedAuthor, SharedAuthorCompanion, SharedChildrenItem, SharedChildrenItemCompanion, SharedItemsItem, SharedItemsItemCompanion, SharedNewsResponse, SharedNewsResponseCompanion, SharedPagination, SharedPaginationCompanion, SharedResponse, SharedResponseCompanion, SharedAppDatabaseCompanion, SharedNotification, SharedIosModuleKt, SharedSharedModuleKt, SharedGetMyViewModelKt, SharedKoinIosMainKt, SharedRuntimeTransacterTransaction, SharedRuntimeQuery<RowType>, SharedKotlinx_serialization_corePolymorphicKind, SharedKotlinx_serialization_corePolymorphicKindOPEN, SharedKotlinx_serialization_corePolymorphicKindSEALED, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_coreSerialKindCONTEXTUAL, SharedKotlinx_serialization_coreSerialKindENUM, SharedKotlinx_serialization_corePrimitiveKind, SharedKotlinx_serialization_corePrimitiveKindBOOLEAN, SharedKotlinx_serialization_corePrimitiveKindBYTE, SharedKotlinx_serialization_corePrimitiveKindCHAR, SharedKotlinx_serialization_corePrimitiveKindDOUBLE, SharedKotlinx_serialization_corePrimitiveKindFLOAT, SharedKotlinx_serialization_corePrimitiveKindINT, SharedKotlinx_serialization_corePrimitiveKindLONG, SharedKotlinx_serialization_corePrimitiveKindSHORT, SharedKotlinx_serialization_corePrimitiveKindSTRING, SharedKotlinx_serialization_coreStructureKind, SharedKotlinx_serialization_coreStructureKindCLASS, SharedKotlinx_serialization_coreStructureKindLIST, SharedKotlinx_serialization_coreStructureKindMAP, SharedKotlinx_serialization_coreStructureKindOBJECT, SharedKotlinx_serialization_coreSerializersModule, SharedKtor_client_coreHttpClient, SharedKtor_client_coreHttpClientCall, SharedKtor_client_coreHttpClientCallCompanion, SharedKtor_client_coreHttpRequestData, SharedKtor_client_coreHttpClientEngineConfig, SharedKtor_client_coreHttpClientConfig<T>, SharedKtor_client_coreHttpReceivePipeline, SharedKtor_client_coreHttpReceivePipelinePhases, SharedKtor_client_coreHttpRequestPipeline, SharedKtor_client_coreHttpRequestPipelinePhases, SharedKtor_client_coreHttpResponsePipeline, SharedKtor_client_coreHttpResponsePipelinePhases, SharedKtor_client_coreHttpSendPipeline, SharedKtor_client_coreHttpSendPipelinePhases, SharedKtor_client_coreHttpResponseData, SharedKtor_client_coreHttpResponse, SharedKtor_client_coreProxyConfig, SharedKtor_client_coreHttpRequestBuilder, SharedKtor_client_coreHttpRequestBuilderCompanion, SharedKtor_client_coreHttpResponseContainer, SharedKtor_ioMemory, SharedKtor_ioMemoryCompanion, SharedKtor_ioChunkBuffer, SharedKtor_ioChunkBufferCompanion, SharedKtor_ioBuffer, SharedKtor_ioBufferCompanion, SharedKtor_ioByteReadPacket, SharedKtor_ioByteReadPacketCompanion, SharedKtor_ioInput, SharedKtor_ioInputCompanion, SharedKoin_coreKoin, SharedKoin_coreModule, SharedKoin_coreScope, SharedKoin_coreLockable, SharedKoin_coreParametersHolder, SharedKoin_coreLogger, SharedKoin_coreExtensionManager, SharedKoin_coreInstanceRegistry, SharedKoin_corePropertyRegistry, SharedKoin_coreScopeRegistry, SharedKoin_coreScopeRegistryCompanion, SharedKoin_coreKoinDefinition<R>, SharedKoin_coreInstanceFactory<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreSingleInstanceFactory<T>, SharedKoin_coreScopeDSL, SharedKoin_coreLevel, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreResolutionContext, SharedKoin_coreKind, SharedKoin_coreCallbacks<T>, SharedKtor_utilsTypeInfo, SharedKtor_utilsPipeline<TSubject, TContext>, SharedKtor_utilsAttributeKey<T>, SharedKtor_utilsPipelinePhase, SharedKtor_utilsGMTDate, SharedKtor_utilsGMTDateCompanion, SharedKtor_utilsStringValuesBuilderImpl, SharedKtor_utilsWeekDay, SharedKtor_utilsWeekDayCompanion, SharedKtor_utilsMonth, SharedKtor_utilsMonthCompanion, SharedKtor_httpOutgoingContent, SharedKtor_httpOutgoingContentProtocolUpgrade, SharedKtor_httpOutgoingContentWriteChannelContent, SharedKtor_httpOutgoingContentByteArrayContent, SharedKtor_httpOutgoingContentNoContent, SharedKtor_httpOutgoingContentReadChannelContent, SharedKtor_httpContentType, SharedKtor_httpContentTypeCompanion, SharedKtor_httpHeaderValueWithParameters, SharedKtor_httpHeaderValueWithParametersCompanion, SharedKtor_httpHttpStatusCode, SharedKtor_httpHttpStatusCodeCompanion, SharedKtor_httpUrl, SharedKtor_httpUrlCompanion, SharedKtor_httpHttpMethod, SharedKtor_httpHttpMethodCompanion, SharedKtor_httpHttpProtocolVersion, SharedKtor_httpHttpProtocolVersionCompanion, SharedKtor_httpHeaderValueParam, SharedKtor_httpURLProtocol, SharedKtor_httpURLProtocolCompanion, SharedKtor_httpHeadersBuilder, SharedKtor_httpURLBuilder, SharedKtor_httpURLBuilderCompanion, SharedKtor_eventsEvents, SharedKtor_eventsEventDefinition<T>, Shared__SkieSuspendWrappersKt, Shared__SkieTypeExportsKt, NSObject, NSError, NSString, NSArray<E>, NSMutableArray<E>, NSSet<E>, NSDictionary<K, V>, NSMutableSet, NSMutableDictionary, NSNumber;

@protocol SharedKotlinSuspendFunction1, SharedKotlinFunction, SharedKotlinAppendable, SharedKotlinCoroutineContext, SharedKotlinCoroutineContextElement, SharedKotlinCoroutineContextKey, SharedKotlinSuspendFunction2, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier, SharedKotlinLazy, SharedKotlinComparable, SharedKotlinIterator, SharedKotlinSequence, SharedKotlinKType, SharedKotlinContinuationInterceptor, SharedKotlinIterable, SharedKotlinClosedRange, SharedKotlinOpenEndRange, SharedKotlinAnnotation, SharedKotlinMapEntry, SharedKotlinContinuation, SharedSkie_DispatcherDelegate, SharedKotlinx_coroutines_coreFlow, SharedKotlinx_coroutines_coreMutableSharedFlow, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreMutableStateFlow, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_coroutines_coreRunnable, SharedKotlinx_coroutines_coreCoroutineScope, SharedKotlinx_coroutines_coreJob, SharedKotlinx_coroutines_coreSelectClause1, SharedKotlinx_coroutines_coreSelectClause, SharedKotlinx_coroutines_coreSelectClause2, SharedKotlinx_coroutines_coreChildHandle, SharedKotlinx_coroutines_coreDisposableHandle, SharedKotlinx_coroutines_coreChildJob, SharedKotlinx_coroutines_coreSelectClause0, SharedKotlinx_coroutines_coreSelectInstance, SharedKotlinx_coroutines_coreParentJob, SharedAppDatabase, SharedAppDatabaseQueries, SharedRuntimeTransacter, SharedRuntimeSqlDriver, SharedRuntimeSqlDriverSchema, SharedRuntimeCloseable, SharedRuntimeTransactionWithoutReturn, SharedRuntimeTransactionCallbacks, SharedRuntimeTransactionWithReturn, SharedRuntimeQueryListener, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlCursor, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKtor_client_coreHttpClientEngine, SharedKtor_client_coreHttpClientEngineCapability, SharedKtor_client_coreHttpRequest, SharedKtor_client_coreHttpClientPlugin, SharedKtor_ioCloseable, SharedKtor_ioByteReadChannel, SharedKtor_ioByteWriteChannel, SharedKtor_ioReadSession, SharedKtor_ioObjectPool, SharedKoin_coreKoinScopeComponent, SharedKoin_coreKoinComponent, SharedKoin_coreQualifier, SharedKoin_coreScopeCallback, SharedKoin_coreKoinExtension, SharedKtor_utilsAttributes, SharedKtor_utilsStringValues, SharedKtor_utilsStringValuesBuilder, SharedKtor_httpHttpMessage, SharedKtor_httpHeaders, SharedKtor_httpHttpMessageBuilder, SharedKtor_httpParameters, SharedKtor_httpParametersBuilder, NSCopying;
...
- (id<SharedKotlinx_coroutines_coreFlow>)getAllArticles __attribute__((swift_name("getAllArticles()")));
- (void)insertArticleNews:(SharedNews *)news __attribute__((swift_name("insertArticle(news:)")));
@end
...
@property (readonly) NSArray<SharedWebStory *> *list __attribute__((swift_name("list")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@property (readonly) NSString *tn __attribute__((swift_name("tn")));
@property (readonly) NSString *wu __attribute__((swift_name("wu")));
- (instancetype)initWithTn:(NSString *)tn title:(NSString *)title desc:(NSString *)desc date:(NSString *)date wu:(NSString *)wu imageUrl:(NSString *)imageUrl list:(NSArray<SharedWebStory *> *)list __attribute__((swift_name("init(tn:title:desc:date:wu:imageUrl:list:)"))) __attribute__((objc_designated_initializer));
- (SharedArticle *)doCopyTn:(NSString *)tn title:(NSString *)title desc:(NSString *)desc date:(NSString *)date wu:(NSString *)wu imageUrl:(NSString *)imageUrl list:(NSArray<SharedWebStory *> *)list __attribute__((swift_name("doCopy(tn:title:desc:date:wu:imageUrl:list:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchArticlesPageNo:(int32_t)pageNo completionHandler:(void (^)(SharedResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchArticles(pageNo:completionHandler:)")));
@end
...
- (NSArray<SharedWebStory *> *)dummyWebStories __attribute__((swift_name("dummyWebStories()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getArticlesCurrentPage:(int32_t)currentPage completionHandler:(void (^)(NSArray<SharedArticle *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getArticles(currentPage:completionHandler:)")));
@end
...
- (instancetype)initWithDbHelper:(SharedDatabaseHelper *)dbHelper __attribute__((swift_name("init(dbHelper:)"))) __attribute__((objc_designated_initializer));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
+ (instancetype)new __attribute__((unavailable));
- (id<SharedKotlinx_coroutines_coreFlow>)fetchAllNotification __attribute__((swift_name("fetchAllNotification()")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchNotificationIosWithCompletionHandler:(void (^)(NSArray<SharedNews *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchNotificationIos(completionHandler:)")));
- (NSArray<SharedWebStory *> *)getDummyWeb __attribute__((swift_name("getDummyWeb()")));
- (void)insertNotificationNews:(SharedNews *)news __attribute__((swift_name("insertNotification(news:)")));
- (void)loadNextPageApi __attribute__((swift_name("loadNextPageApi()")));
- (SharedNews *)toNews:(SharedNotification *)receiver __attribute__((swift_name("toNews(_:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("WebStory")))
@interface SharedWebStory : SharedBase
@property (readonly) NSString *date __attribute__((swift_name("date")));
@property (readonly) NSString *desc __attribute__((swift_name("desc")));
@property (readonly) int32_t imageNo __attribute__((swift_name("imageNo")));
@property (readonly) NSString *imageUrl __attribute__((swift_name("imageUrl")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@property (readonly) NSString *wu __attribute__((swift_name("wu")));
- (instancetype)initWithWu:(NSString *)wu date:(NSString *)date title:(NSString *)title desc:(NSString *)desc imageNo:(int32_t)imageNo imageUrl:(NSString *)imageUrl __attribute__((swift_name("init(wu:date:title:desc:imageNo:imageUrl:)"))) __attribute__((objc_designated_initializer));
- (SharedWebStory *)doCopyWu:(NSString *)wu date:(NSString *)date title:(NSString *)title desc:(NSString *)desc imageNo:(int32_t)imageNo imageUrl:(NSString *)imageUrl __attribute__((swift_name("doCopy(wu:date:title:desc:imageNo:imageUrl:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@property (class, readonly, getter=companion) SharedNewsCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString *date __attribute__((swift_name("date")));
@property (readonly) NSString *image __attribute__((swift_name("image")));
@property (readonly) int64_t timeInMills __attribute__((swift_name("timeInMills")));
@property (readonly) NSString *title __attribute__((swift_name("title")));
@property NSString *wu __attribute__((swift_name("wu")));
- (instancetype)initWithWu:(NSString *)wu date:(NSString *)date image:(NSString *)image title:(NSString *)title timeInMills:(int64_t)timeInMills __attribute__((swift_name("init(wu:date:image:title:timeInMills:)"))) __attribute__((objc_designated_initializer));
- (SharedNews *)doCopyWu:(NSString *)wu date:(NSString *)date image:(NSString *)image title:(NSString *)title timeInMills:(int64_t)timeInMills __attribute__((swift_name("doCopy(wu:date:image:title:timeInMills:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
@interface SharedNewsCompanion : SharedBase
@property (class, readonly, getter=shared) SharedNewsCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SharedAuthor : SharedBase
@property (class, readonly, getter=companion) SharedAuthorCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) NSString * _Nullable authorId __attribute__((swift_name("authorId")));
@property (readonly) NSString * _Nullable imageUrl __attribute__((swift_name("imageUrl")));
@property (readonly) NSString * _Nullable name __attribute__((swift_name("name")));
- (instancetype)initWithImageUrl:(NSString * _Nullable)imageUrl name:(NSString * _Nullable)name authorId:(NSString * _Nullable)authorId __attribute__((swift_name("init(imageUrl:name:authorId:)"))) __attribute__((objc_designated_initializer));
- (SharedAuthor *)doCopyImageUrl:(NSString * _Nullable)imageUrl name:(NSString * _Nullable)name authorId:(NSString * _Nullable)authorId __attribute__((swift_name("doCopy(imageUrl:name:authorId:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="authorId")
*/
...
@interface SharedAuthorCompanion : SharedBase
@property (class, readonly, getter=shared) SharedAuthorCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChildrenItem")))
@interface SharedChildrenItem : SharedBase
@property (class, readonly, getter=companion) SharedChildrenItemCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) SharedAuthor * _Nullable author __attribute__((swift_name("author")));
@property (readonly) NSString * _Nullable caption __attribute__((swift_name("caption")));
@property (readonly) SharedLong * _Nullable dl __attribute__((swift_name("dl")));
@property (readonly) NSString * _Nullable hl __attribute__((swift_name("hl")));
@property (readonly) SharedInt * _Nullable hostid __attribute__((swift_name("hostid")));
@property (readonly) NSString * _Nullable imageUrl __attribute__((swift_name("imageUrl")));
@property (readonly) SharedLong * _Nullable lpt __attribute__((swift_name("lpt")));
@property (readonly) SharedInt * _Nullable msid __attribute__((swift_name("msid")));
@property (readonly) NSString * _Nullable su __attribute__((swift_name("su")));
@property (readonly) NSString * _Nullable tn __attribute__((swift_name("tn")));
@property (readonly) NSString * _Nullable upd __attribute__((swift_name("upd")));
@property (readonly) NSString * _Nullable wu __attribute__((swift_name("wu")));
- (instancetype)initWithLpt:(SharedLong * _Nullable)lpt su:(NSString * _Nullable)su msid:(SharedInt * _Nullable)msid hl:(NSString * _Nullable)hl author:(SharedAuthor * _Nullable)author imageUrl:(NSString * _Nullable)imageUrl dl:(SharedLong * _Nullable)dl upd:(NSString * _Nullable)upd caption:(NSString * _Nullable)caption hostid:(SharedInt * _Nullable)hostid tn:(NSString * _Nullable)tn wu:(NSString * _Nullable)wu __attribute__((swift_name("init(lpt:su:msid:hl:author:imageUrl:dl:upd:caption:hostid:tn:wu:)"))) __attribute__((objc_designated_initializer));
- (SharedChildrenItem *)doCopyLpt:(SharedLong * _Nullable)lpt su:(NSString * _Nullable)su msid:(SharedInt * _Nullable)msid hl:(NSString * _Nullable)hl author:(SharedAuthor * _Nullable)author imageUrl:(NSString * _Nullable)imageUrl dl:(SharedLong * _Nullable)dl upd:(NSString * _Nullable)upd caption:(NSString * _Nullable)caption hostid:(SharedInt * _Nullable)hostid tn:(NSString * _Nullable)tn wu:(NSString * _Nullable)wu __attribute__((swift_name("doCopy(lpt:su:msid:hl:author:imageUrl:dl:upd:caption:hostid:tn:wu:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="dl")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="hl")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="hostid")
*/
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="lpt")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="msid")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="su")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="tn")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="upd")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="wu")
*/
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ChildrenItem.Companion")))
@interface SharedChildrenItemCompanion : SharedBase
@property (class, readonly, getter=shared) SharedChildrenItemCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemsItem")))
@interface SharedItemsItem : SharedBase
@property (class, readonly, getter=companion) SharedItemsItemCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) SharedAuthor * _Nullable author __attribute__((swift_name("author")));
@property (readonly) NSString * _Nullable caption __attribute__((swift_name("caption")));
@property (readonly) NSArray<id> * _Nullable children __attribute__((swift_name("children")));
@property (readonly) SharedLong * _Nullable dl __attribute__((swift_name("dl")));
@property (readonly) NSString * _Nullable hl __attribute__((swift_name("hl")));
@property (readonly) SharedInt * _Nullable hostid __attribute__((swift_name("hostid")));
@property (readonly) NSString * _Nullable imageUrl __attribute__((swift_name("imageUrl")));
...
@property (readonly) NSString * _Nullable upd __attribute__((swift_name("upd")));
@property (readonly) NSString * _Nullable wu __attribute__((swift_name("wu")));
- (instancetype)initWithSu:(NSString * _Nullable)su hl:(NSString * _Nullable)hl author:(SharedAuthor * _Nullable)author dl:(SharedLong * _Nullable)dl upd:(NSString * _Nullable)upd caption:(NSString * _Nullable)caption hostid:(SharedInt * _Nullable)hostid lpt:(SharedLong * _Nullable)lpt msid:(SharedInt * _Nullable)msid children:(NSArray<id> * _Nullable)children imageUrl:(NSString * _Nullable)imageUrl tn:(NSString * _Nullable)tn wu:(NSString * _Nullable)wu __attribute__((swift_name("init(su:hl:author:dl:upd:caption:hostid:lpt:msid:children:imageUrl:tn:wu:)"))) __attribute__((objc_designated_initializer));
- (SharedItemsItem *)doCopySu:(NSString * _Nullable)su hl:(NSString * _Nullable)hl author:(SharedAuthor * _Nullable)author dl:(SharedLong * _Nullable)dl upd:(NSString * _Nullable)upd caption:(NSString * _Nullable)caption hostid:(SharedInt * _Nullable)hostid lpt:(SharedLong * _Nullable)lpt msid:(SharedInt * _Nullable)msid children:(NSArray<id> * _Nullable)children imageUrl:(NSString * _Nullable)imageUrl tn:(NSString * _Nullable)tn wu:(NSString * _Nullable)wu __attribute__((swift_name("doCopy(su:hl:author:dl:upd:caption:hostid:lpt:msid:children:imageUrl:tn:wu:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="children")
*/
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ItemsItem.Companion")))
@interface SharedItemsItemCompanion : SharedBase
@property (class, readonly, getter=shared) SharedItemsItemCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SharedNewsResponse : SharedBase
@property (class, readonly, getter=companion) SharedNewsResponseCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) SharedResponse *response __attribute__((swift_name("response")));
@property (readonly) SharedBoolean * _Nullable status __attribute__((swift_name("status")));
- (instancetype)initWithResponse:(SharedResponse *)response status:(SharedBoolean * _Nullable)status __attribute__((swift_name("init(response:status:)"))) __attribute__((objc_designated_initializer));
- (SharedNewsResponse *)doCopyResponse:(SharedResponse *)response status:(SharedBoolean * _Nullable)status __attribute__((swift_name("doCopy(response:status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedNewsResponseCompanion : SharedBase
@property (class, readonly, getter=shared) SharedNewsResponseCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SharedPagination : SharedBase
@property (class, readonly, getter=companion) SharedPaginationCompanion *companion __attribute__((swift_name("companion")));
@property (readonly) SharedInt * _Nullable curPage __attribute__((swift_name("curPage")));
@property (readonly) SharedInt * _Nullable perPage __attribute__((swift_name("perPage")));
@property (readonly) SharedInt * _Nullable totalItems __attribute__((swift_name("totalItems")));
@property (readonly) SharedInt * _Nullable totalPages __attribute__((swift_name("totalPages")));
- (instancetype)initWithTotalItems:(SharedInt * _Nullable)totalItems perPage:(SharedInt * _Nullable)perPage curPage:(SharedInt * _Nullable)curPage totalPages:(SharedInt * _Nullable)totalPages __attribute__((swift_name("init(totalItems:perPage:curPage:totalPages:)"))) __attribute__((objc_designated_initializer));
- (SharedPagination *)doCopyTotalItems:(SharedInt * _Nullable)totalItems perPage:(SharedInt * _Nullable)perPage curPage:(SharedInt * _Nullable)curPage totalPages:(SharedInt * _Nullable)totalPages __attribute__((swift_name("doCopy(totalItems:perPage:curPage:totalPages:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="curPage")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="perPage")
*/

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="totalItems")
*/
...
@interface SharedPaginationCompanion : SharedBase
@property (class, readonly, getter=shared) SharedPaginationCompanion *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@property (readonly) NSArray<SharedItemsItem *> *items __attribute__((swift_name("items")));
@property (readonly) SharedPagination * _Nullable pagination __attribute__((swift_name("pagination")));
- (instancetype)initWithPagination:(SharedPagination * _Nullable)pagination items:(NSArray<SharedItemsItem *> *)items __attribute__((swift_name("init(pagination:items:)"))) __attribute__((objc_designated_initializer));
- (SharedResponse *)doCopyPagination:(SharedPagination * _Nullable)pagination items:(NSArray<SharedItemsItem *> *)items __attribute__((swift_name("doCopy(pagination:items:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="pagination")
*/
@end
...
@required
- (void)insertArticleTitle:(NSString *)title wu:(NSString *)wu image:(NSString *)image date:(NSString *)date milliSeconds:(int64_t)milliSeconds __attribute__((swift_name("insertArticle(title:wu:image:date:milliSeconds:)")));
- (SharedRuntimeQuery<SharedNotification *> *)selectAll __attribute__((swift_name("selectAll()")));
- (SharedRuntimeQuery<id> *)selectAllMapper:(id (^)(SharedLong *, NSString *, NSString *, NSString *, NSString *, SharedLong *))mapper __attribute__((swift_name("selectAll(mapper:)")));
@end
...
@property (readonly) NSString *title __attribute__((swift_name("title")));
@property (readonly) NSString *wu __attribute__((swift_name("wu")));
- (instancetype)initWithId:(int64_t)id title:(NSString *)title wu:(NSString *)wu image:(NSString *)image date:(NSString *)date milliSeconds:(int64_t)milliSeconds __attribute__((swift_name("init(id:title:wu:image:date:milliSeconds:)"))) __attribute__((objc_designated_initializer));
- (SharedNotification *)doCopyId:(int64_t)id title:(NSString *)title wu:(NSString *)wu image:(NSString *)image date:(NSString *)date milliSeconds:(int64_t)milliSeconds __attribute__((swift_name("doCopy(id:title:wu:image:date:milliSeconds:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("KoinIosMainKt")))
@interface SharedKoinIosMainKt : SharedBase
+ (SharedKoin_coreKoin *)doInitKoinIos __attribute__((swift_name("doInitKoinIos()")));
@end
...
+ (void)Skie_Suspend__33__awaitFreeSpaceDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__33__awaitFreeSpace(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__34__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKtor_ioChunkBuffer *)src suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__34__writeAvailable(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__35__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__35__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__36__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__36__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__37__writeAvailableDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__37__writeAvailable(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__38__writeByteDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver b:(int8_t)b suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__38__writeByte(dispatchReceiver:b:suspendHandler:)")));
+ (void)Skie_Suspend__39__writeDoubleDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver d:(double)d suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__39__writeDouble(dispatchReceiver:d:suspendHandler:)")));
+ (void)Skie_Suspend__3__fetchArticlesDispatchReceiver:(SharedArticlesService *)dispatchReceiver pageNo:(int32_t)pageNo suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__3__fetchArticles(dispatchReceiver:pageNo:suspendHandler:)")));
+ (void)Skie_Suspend__40__writeFloatDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver f:(float)f suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__40__writeFloat(dispatchReceiver:f:suspendHandler:)")));
+ (void)Skie_Suspend__41__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver memory:(SharedKtor_ioMemory *)memory startIndex:(int32_t)startIndex endIndex:(int32_t)endIndex suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__41__writeFully(dispatchReceiver:memory:startIndex:endIndex:suspendHandler:)")));
+ (void)Skie_Suspend__42__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKtor_ioBuffer *)src suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__42__writeFully(dispatchReceiver:src:suspendHandler:)")));
+ (void)Skie_Suspend__43__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(SharedKotlinByteArray *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__43__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__44__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int32_t)offset length:(int32_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__44__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__45__writeFullyDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver src:(void *)src offset:(int64_t)offset length:(int64_t)length suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__45__writeFully(dispatchReceiver:src:offset:length:suspendHandler:)")));
+ (void)Skie_Suspend__46__writeIntDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver i:(int32_t)i suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__46__writeInt(dispatchReceiver:i:suspendHandler:)")));
+ (void)Skie_Suspend__47__writeLongDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver l:(int64_t)l suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__47__writeLong(dispatchReceiver:l:suspendHandler:)")));
+ (void)Skie_Suspend__48__writePacketDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver packet:(SharedKtor_ioByteReadPacket *)packet suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__48__writePacket(dispatchReceiver:packet:suspendHandler:)")));
+ (void)Skie_Suspend__49__writeShortDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver s:(int16_t)s suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__49__writeShort(dispatchReceiver:s:suspendHandler:)")));
+ (void)Skie_Suspend__4__getArticlesDispatchReceiver:(SharedArticlesUseCase *)dispatchReceiver currentPage:(int32_t)currentPage suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__4__getArticles(dispatchReceiver:currentPage:suspendHandler:)")));
+ (void)Skie_Suspend__50__writeSuspendSessionDispatchReceiver:(id<SharedKtor_ioByteWriteChannel>)dispatchReceiver visitor:(id<SharedKotlinSuspendFunction1>)visitor suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__50__writeSuspendSession(dispatchReceiver:visitor:suspendHandler:)")));
+ (void)Skie_Suspend__51__joinDispatchReceiver:(id<SharedKotlinx_coroutines_coreJob>)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__51__join(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__52__invokeDispatchReceiver:(id<SharedKotlinSuspendFunction2>)dispatchReceiver p1:(id _Nullable)p1 p2:(id _Nullable)p2 suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__52__invoke(dispatchReceiver:p1:p2:suspendHandler:)")));
+ (void)Skie_Suspend__53__bodyDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(SharedKtor_utilsTypeInfo *)info suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__53__body(dispatchReceiver:info:suspendHandler:)")));
+ (void)Skie_Suspend__54__bodyNullableDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver info:(SharedKtor_utilsTypeInfo *)info suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__54__bodyNullable(dispatchReceiver:info:suspendHandler:)")));

/**
 * @note This method has protected visibility in Kotlin source and is intended only for use by subclasses.
*/
+ (void)Skie_Suspend__55__getResponseContentDispatchReceiver:(SharedKtor_client_coreHttpClientCall *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__55__getResponseContent(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__56__invokeDispatchReceiver:(id<SharedKotlinSuspendFunction1>)dispatchReceiver p1:(id _Nullable)p1 suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__56__invoke(dispatchReceiver:p1:suspendHandler:)")));
+ (void)Skie_Suspend__5__fetchNotificationIosDispatchReceiver:(SharedArticlesViewModel *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__5__fetchNotificationIos(dispatchReceiver:suspendHandler:)")));
+ (void)Skie_Suspend__6__upgradeDispatchReceiver:(SharedKtor_httpOutgoingContentProtocolUpgrade *)dispatchReceiver input:(id<SharedKtor_ioByteReadChannel>)input output:(id<SharedKtor_ioByteWriteChannel>)output engineContext:(id<SharedKotlinCoroutineContext>)engineContext userContext:(id<SharedKotlinCoroutineContext>)userContext suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__6__upgrade(dispatchReceiver:input:output:engineContext:userContext:suspendHandler:)")));
+ (void)Skie_Suspend__7__writeToDispatchReceiver:(SharedKtor_httpOutgoingContentWriteChannelContent *)dispatchReceiver channel:(id<SharedKtor_ioByteWriteChannel>)channel suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__7__writeTo(dispatchReceiver:channel:suspendHandler:)")));
+ (void)Skie_Suspend__8__executeDispatchReceiver:(id<SharedKtor_client_coreHttpClientEngine>)dispatchReceiver data:(SharedKtor_client_coreHttpRequestData *)data suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__8__execute(dispatchReceiver:data:suspendHandler:)")));
+ (void)Skie_Suspend__9__executeDispatchReceiver:(SharedKtor_utilsPipeline<id, id> *)dispatchReceiver context:(id)context subject:(id)subject suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__9__execute(dispatchReceiver:context:subject:suspendHandler:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("__SkieTypeExportsKt")))
@interface Shared__SkieTypeExportsKt : SharedBase
+ (void)skieTypeExports_0P0:(SharedKotlinx_serialization_corePolymorphicKind *)p0 p1:(SharedKotlinx_serialization_corePrimitiveKind *)p1 p2:(SharedKotlinx_serialization_coreSerialKindCONTEXTUAL *)p2 p3:(SharedKotlinx_serialization_coreSerialKindENUM *)p3 p4:(SharedKotlinx_serialization_coreStructureKind *)p4 p5:(SharedKotlinx_serialization_corePolymorphicKindOPEN *)p5 p6:(SharedKotlinx_serialization_corePolymorphicKindSEALED *)p6 p7:(SharedKotlinx_serialization_corePrimitiveKindBOOLEAN *)p7 p8:(SharedKotlinx_serialization_corePrimitiveKindBYTE *)p8 p9:(SharedKotlinx_serialization_corePrimitiveKindCHAR *)p9 p10:(SharedKotlinx_serialization_corePrimitiveKindDOUBLE *)p10 p11:(SharedKotlinx_serialization_corePrimitiveKindFLOAT *)p11 p12:(SharedKotlinx_serialization_corePrimitiveKindINT *)p12 p13:(SharedKotlinx_serialization_corePrimitiveKindLONG *)p13 p14:(SharedKotlinx_serialization_corePrimitiveKindSHORT *)p14 p15:(SharedKotlinx_serialization_corePrimitiveKindSTRING *)p15 p16:(SharedKotlinx_serialization_coreStructureKindCLASS *)p16 p17:(SharedKotlinx_serialization_coreStructureKindLIST *)p17 p18:(SharedKotlinx_serialization_coreStructureKindMAP *)p18 p19:(SharedKotlinx_serialization_coreStructureKindOBJECT *)p19 p20:(SharedKtor_httpOutgoingContentByteArrayContent *)p20 p21:(SharedKtor_httpOutgoingContentNoContent *)p21 p22:(SharedKtor_httpOutgoingContentProtocolUpgrade *)p22 p23:(SharedKtor_httpOutgoingContentReadChannelContent *)p23 p24:(SharedKtor_httpOutgoingContentWriteChannelContent *)p24 p25:(id<SharedKotlinx_coroutines_coreSelectClause1>)p25 p26:(id<SharedKotlinx_coroutines_coreSelectClause2>)p26 __attribute__((swift_name("skieTypeExports_0(p0:p1:p2:p3:p4:p5:p6:p7:p8:p9:p10:p11:p12:p13:p14:p15:p16:p17:p18:p19:p20:p21:p22:p23:p24:p25:p26:)")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("GetMyViewModelKt")))
@interface SharedGetMyViewModelKt : SharedBase
+ (SharedArticlesViewModel *)getMyViewModel __attribute__((swift_name("getMyViewModel()")));
@end
...
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (SharedLong *)next__ __attribute__((swift_name("next_()")));
